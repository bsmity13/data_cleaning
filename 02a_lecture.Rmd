...
BibOptions(check.entries = FALSE, bib.style = "authoryear", style = "markdown",
           dashed = TRUE)
bib <- ReadBib("02_refs.bib")
```

class: center, middle, inverse

# GPS Data Cleaning with `amt`
...
- Developed primarily to assist with iSSA  

- Follows tidy data principles  

- Home range fitting, HSF/iSSF fitting, simulation, validation  

]

.pull-right[
![Johannes Signer](https://www.uni-goettingen.de/storage/pictures/2464f46f486bbd11c88ad5e55a6d74ba.png)  

Johannes Signer  

`amt` creator and primary author
]
...
- Updates are submitted to CRAN after major changes.
...
.center[
<s>"Two trains leave a station..."</s>  

"A particle is moving through space..."
...
![First step](figs/one_step.png)  
How far has it gone from the start location after 50 hours?
...
![Ballistic](figs/ballistic.png)  

---

class: center, middle

![Diffusive](figs/diffusive.png) 
---

class: center, middle

![Ballistic vs Diffusive](figs/combined.png)  
...
Displacement (under a random walk) *does not* scale linearly with time, but rather **squared** displacement *does* scale linearly with time.
